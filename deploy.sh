...
git config user.email "mark.knol@gmail.com"

# add the CNAME file
echo haxdevelop.org > CNAME
...
git push --force --quiet "https://${GH_TOKEN}@github.com/HaxeFoundation/haxedevelop.org.git" master:gh-pages > /dev/null 2>&1
